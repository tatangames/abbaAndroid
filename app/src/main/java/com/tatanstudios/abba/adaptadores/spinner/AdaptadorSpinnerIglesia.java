...
public class AdaptadorSpinnerIglesia extends ArrayAdapter<String> {


    private Context context;

    public AdaptadorSpinnerIglesia(@NonNull Context context, int resource, @NonNull String[] objects) {
