...
public class AdaptadorBloqueHorizontalVista extends RecyclerView.Adapter<AdaptadorBloqueHorizontalVista.MyViewHolder> {
    ...
    public AdaptadorBloqueHorizontalVista(Context context, List<ModeloMisPlanesBloques>
            modeloMisPlanesBloques, RecyclerView recyclerView, int tema, int hayDiaActual, int idUltimoBloque,
                                          PlanesBloquesVistaActivity planesBloquesVistaActivity) {
    ...
    @NonNull
    @Override
    public AdaptadorBloqueHorizontalVista.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdaptadorBloqueHorizontalVista.MyViewHolder holder, int position) {
                    ...
                    if(hayDiaActual == 1){
                        if(m.getMismodia() == 1){
                            if(primerBloqueDrawable){
                                ...
                                planesBloquesVistaActivity.llenarDatosAdapterVertical(modeloMisPlanesBloques.get(position).getModeloMisPlanesBloqueDetalles());
